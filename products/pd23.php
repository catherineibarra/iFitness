...
<head>
  <title> Product 23 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/230.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/231.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/232.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/233.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/234.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/235.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/236.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/237.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/238.jpg" id="zoom" alt="" />
            </div>
      ...
      <div class="right">
        ...
        <h1>Jx930 158LBS (72KG) Stack Weights JX Fitness Home GYM<h1>
            ...
            <p>
            Improve your overall appearance, strength, and athletic performance with the three-station home gym. <br>
            With over 20 total body strength, shape, and conditioning exercises included, <br>
            you can custom build training workouts to target specific muscle areas.<br>
             This compact three-station includes tricep extension, <br>
            abdominal crunch, leg curl station, leg kick back, preacher curl, upright row, boxing, <br>
            seated shoulder press, and so on.<br>
            </p>
      </div>
