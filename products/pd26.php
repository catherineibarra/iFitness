...
<head>
  <title> Product 26 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/260.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/261.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/262.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/263.jpg" id="zoom" alt="" />
            </div>
      ...
      <div class="right">
        ...
        <h1>Bike Spin Stationary Shock Absorbing <h1>
            <div class="price">$379.97</div>
            ...
            <p>
            Boost your immune system and manage your weight with Genki Exercise Bike Spin Stationary Bicycle Shock Absorbing Home Gym Fitness Equipment. <br>
            Boasting a rugged and strong structure coated with scratch-resistant paint, <br>
            the professional spin bike allows for reliable firmness and unbelievable durability for a long time of service and a max load-bearing capacity of 150kg<br> 
            Composed of a 13kg chromed flywheel, a smooth belt drive system, adjustable magnetic resistance modes and transportation wheels, <br>
            the gym equipment ensures incredible silence, ease of use and versatile flexibility during indoor cycling. Furthermore, <br>
            an adjustable thick padded seat contributes to the ultimate comfort and a large LCD monitor can help track your time, speed, distance, calories and more. <br>
            </p>
      </div>
