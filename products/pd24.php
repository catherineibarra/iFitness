...
<head>
  <title> Product 24 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/240.jpg" id="zoom" alt="" />
            </div>
          </div>
      ...
      <div class="right">
        ...
        <h1>Gym Weight Training Exercise Equipment Strength Machine<h1>
            ...
            <p>
            Save yourself the time and hassle of a gym membership with this gym system strength training workout equipment.<br>

This complete workout unit includes everything you need to engage your entire body for better health and more powerful,<br>
 lean muscle growth. It features a high and low pulley system with up to 220 lbs of resistance. Use it to target and tone multiple muscle groups.<br>
  It also has a combined chest presstterfly arms station with a 4-roll leg developer. Store it in a spare room or a garage for easy access.<br> 
  It has a sewn vinyl seat for a comfortable workout experience and comes with a step-by-step exercise chart to ensure you're maximizing each movement.<br>

When it comes to building your fitness, a home gym is a good alternative or supplement to a full gym membership. 
            </p>
      </div>
