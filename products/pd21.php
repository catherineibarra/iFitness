...
<head>
  <title> Product 21 | iFitness </title>
  <meta charset="utf-8">
    ...
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/210.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/211.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/212.jpg" id="zoom" alt="" />
            </div>
      ...
      <div class="right">
        ...
        <h1>Rockit Dumbbell Rack<h1>
            ...
            <p>
            Heavy guage steel<br>
            Matt anti-scratch painting<br>
            Upgraded nylon saddle
            </p>
      </div>
