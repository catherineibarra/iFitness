...
<head>
  <title> Product 15 | iFitness </title>
  <meta charset="utf-8">
...
<body>
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/150.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/151.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/152.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/153.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/154.jpg" id="zoom" alt="" />
            </div>
          </div>
      ...
      <div class="right">
        <span>SHEIN Cut Out Sports Bra & Leggings</span>
        <h1>Sports Bra & Leggings<h1>
