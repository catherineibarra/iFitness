...
<head>
  <title> Product 22 | iFitness </title>
  <meta charset="utf-8">
...
<body>
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/220.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/221.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/222.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/223.jpg" id="zoom" alt="" />
            </div>
          </div>
      ...
      <div class="right">
        <span>Home Gym Power Tower Fitness Workout Equipment Height Adjustable Chin Pull Up Bar Dip Station Weight Bench</span>
        <h1>Adjustable Chin Pull Up Bar Dip Station Weight Bench<h1>
            <div class="price">$319.97</div>
            ...
            <p>
            Build up your physical strength and tone your muscles with this Gym Power Tower Fitness Workout Equipment. <br>
            Crafted from heavy-duty steel pipes painted with a powder finish, the workout station is rugged, <br>
            durable and stable for years of intense use. In addition to the great value and high performance,<br>
             the exercise equipment with a height-adjustable pull-up bar is anti-sweat for comfortable operation and is practical to suit different heights and requirements. Furthermore, engineered with a weight bench, a barbell holder as well as a pull-up tower, <br>
             this home gym equipment trains your entire body with a wide range of workouts including bench press, <br>
            pull-up, push-up, power training, barbell exercise, leg lift and stretch. <br>
            To give maximum comfort and safety, a high-density foam padded cushion with a vinyl cover is provided.<br>
            Pluas, the non-slip rubber feet work for extra security and firmness. 
            </p>
      </div>
    ...
    <div class="product-center container">
      ...
      <div class="product-item">
        ...
        <div class="product-info">
          ...
          <a href="pd20.php">Height Adjustable Chin Pull Up Bar Dip Station Weight Bench</a>
          <h4>$319.97</h4>
        </div>
        <ul class="icons">
          <li><i class="bx bx-heart"></i></li>
