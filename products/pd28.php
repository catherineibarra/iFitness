...
<head>
  <title> Product 28 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/280.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/281.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/282.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/283.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/284.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/286.jpg" id="zoom" alt="" />
            </div>
          </div>
      ...
      <div class="right">
        ...
        <h1>Centra Magnetic Rowing Machine 8 Level Resistance Exercise Fitness Home Gym<h1>
            ...
            <p>
            Rowing is a great way to build fitness and improve body composition. <br>
            Your new magnetic rowing machine means you do not even need to be on the water to get those gains.  <br>
            Grab the handle and start rowing. <br>

Switch between 8 levels of resistance in your rowing machine.  <br>
Warm-up slowly. Increase the difficulty of your workout to build muscle.  <br>
Reduce the resistance to build up your cardio.<br>
Enjoy the quiet operation of your magnetic rower. <br>
No longer the big noises from air or water rowers.<br>
 Stop scaring your dog when you just want to exercise. <br>
 Keep peace with your housemates.<br>
Protect your floors. Rubber coating stops you sliding around too. <br>
Maintain proper posture and technique. <br>
Gentler on your knees and ankles than running indoors or outdoors.<br>

Spend 30 minutes pretending to row along your local river.<br>
 When it is time to stop, fold your rowing machine up and pack it into your cupboard. <br>
 Treat your machine well and it will treat you well.<br>
            </p>
      </div>
