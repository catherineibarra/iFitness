...
<head>
  <title> Product 16 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/162.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/160.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/161.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/163.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/164.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/165.jpg" id="zoom" alt="" />
            </div>
          </div>
      ...
      <div class="right">
        ...
        <h1>Seamless Long Sleeve Top<h1>
