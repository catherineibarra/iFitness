...
<head>
  <title> Product 30 | iFitness </title>
  <meta charset="utf-8">
  ...
  <section class="section product-detail">
    <div class="details product-container">
        ...
        <div class="slideshow-container">
          <div class="main">
            <div class="mySlides fade">
              <img src="../images/300.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/301.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/302.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/303.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/304.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/305.jpg" id="zoom" alt="" />
            </div>
            <div class="mySlides fade">
              <img src="../images/306.jpg" id="zoom" alt="" />
            </div>
      ...
      <div class="right">
        ...
        <h1>Wall Mounted Pull Up<h1>
            <div class="price">$756.99</div>
            ...
            <p>
            Material Steel pipe Color Black, White Size (L) x (W) x (H) 97 x 90 x 230 cm / 38.19 x 35.43 x 90.55 inch. <br>
             Features: Structure with steel pipe, quite safe and stable.<br>
             Easy to assemble and suitable for home fitness setting. <br>
            </p>
      </div>
